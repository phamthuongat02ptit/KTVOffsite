...
import { TextInput, Surface, Divider, HelperText, Searchbar, Provider as PaperProvider, useTheme } from 'react-native-paper';
import { View, Dimensions, Platform, FlatList, ActivityIndicator } from 'react-native';
...
const Dropdown = props => {
  ...
  useEffect(() => {
    if (isVisible && selected) {
      const selectedIndex = Lo.findIndex(options, {
        value: selected
      });
  ...
  return /*#__PURE__*/React.createElement(PaperProvider, {
    ...
    visible: hasError
  }, helperText ? helperText : "".concat(label, " is required")) : null), /*#__PURE__*/React.createElement(Modal, {
    isVisible: isVisible,
