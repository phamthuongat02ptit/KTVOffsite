...
import { TextInput, Surface, Divider, HelperText, Searchbar, Caption, Chip, Text, Avatar, Provider as PaperProvider, useTheme } from 'react-native-paper';
...
import { colors as ConsColors, defaultDropdownProps, ITEMLAYOUT } from '../constants';
import styles from '../styles';
import { deviceWidth, deviceHeight } from '../util';
import EmptyList from '../Components/EmptyList';
import PressableTouch from '../Components/PressableTouch'; // const theme = {
//   ...DefaultTheme,
//   roundness: 2,
//   colors: {
//     ...DefaultTheme.colors,
...
const MultiselectDropdown = props => {
  ...
  useEffect(() => {
    if (!Lo.isEmpty(data) && value) {
      setLabelV("".concat(value.length, " ").concat(selectedItemsText || 'selected'));
  ...
  return /*#__PURE__*/React.createElement(PaperProvider, {
    ...
    visible: hasError
  }, helperText ? helperText : "".concat(label, " is required")) : null), !hideChip && /*#__PURE__*/React.createElement(FlatList, {
    data: selectedItems,
  ...
  })) : null, /*#__PURE__*/React.createElement(View, null, !hideChip && /*#__PURE__*/React.createElement(FlatList, {
    data: selectedItems,
    style: styles.chipScrollView,
    horizontal: true,
    keyExtractor: () => Math.random().toString(),
